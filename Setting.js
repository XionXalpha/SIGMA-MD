...
global.owner = process.env.OWNER_NUMBER  || '94789088223' ;  // ADD YOUR NUMBER WITHOUT +
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '24_07_2024_SIGMA_MD_vUKVQ0iQ_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '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',      // ADD YOUR STICKER AUTHOR NAME
